        ...
        forms: function() {
            ...
            o.validate({
                ...
                return e.hide().html(), o.valid() ? ($.ajax({
                    type: "POST",
                    url: "https://saras-website.herokuapp.com/contact",
                    ...
                    success: function(t) {
                        a = "OK" === t ? '<div class="alert alert-success">Done! Thanks for your message - I will get back to you as fast as possible!' : '<div class="alert alert-danger">Ooops... It seems that we have a problem.', e.html(a), e.show()
                    }
                }), !1) : !1
            })
        }
